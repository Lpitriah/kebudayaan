...
@section('title', 'Tambah Layanan Laundry Baru')
        ...
        <div class="card-header bg-gradient-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-semibold">
                    <i class="fas fa-user-plus me-2"></i>Tambah Layanan Laundry Baru
                </h5>
            </div>
        </div>
        
        <div class="card-body p-4">
            <form action="{{ route('layanan_laundry.store') }}" method="POST">
                @csrf
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="kode_layanan" class="form-label fw-semibold text-muted">Kode Layanan</label>
                            <input type="text" class="form-control rounded-lg" id="kode_layanan" name="kode_layanan" 
                                   value="{{ old('kode_layanan') }}" placeholder="Kosongkan untuk generate otomatis">
                            @error('kode_layanan')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="deskripsi" class="form-control rounded-lg" id="deskripsi" name="deskripsi" 
                                   value="{{ old('deskripsi') }}">
                            @error('deskrispi')
                                <div class="text-danger small mt-1">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-lg" id="harga_per_kg" name="harga_per_kg" rows="3">{{ old('harga_per_kg') }}</textarea>
                            @error('harga_per_kg')
                                <div class="text-danger small mt-1">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end gap-3 mt-4">
                            <a href="{{ route('layanan_laundry.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
